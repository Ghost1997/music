...
function ChannelDetail() {
  ...
  const handlePlayAll = () => {
    if (allSongs.length > 0) {
      playSongWithContext(allSongs[0], `channel-${channelName}`, allSongs);
    }
  };

  const handlePlaySong = (song) => {
    playSongWithContext(song, `channel-${channelName}`, allSongs);
  };
    ...
    return (
      <div className="artist-detail-container">
        <div className="empty-state">
          <h2>No songs found for this channel</h2>
    ...
    <div className="artist-detail-container">
      <div className="artist-detail-header">
        <div className="artist-header-image">
          <img src={allSongs[0].thumbnail} alt={channelName} />
        </div>
        <div className="artist-header-info">
          <span className="header-type">Channel</span>
          <h1>{channelName}</h1>
